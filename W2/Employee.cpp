...
namespace seneca {
   ...
   // this holds the records of employees in the file.
   // this should be used for setting or allocating the dynamic memory of an array.
   int noOfEmployees;

   // this stores the address of dynamically allocated memory of employee. and the size of this is "noOfEmployees."
   Employee* employees;
   ...
   bool load() 
   {
      ...
      if (openFile(DATAFILE)) 
      {
          ...
          */
            ...
            for (int i = 0; i < noOfLoadedEmployees; i++)
            {
               noOfEmployees++;
            }
